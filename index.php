    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <a href="https://client.googiehost.com/aff.php?aff=7135"><img class="img-fluid" src="https://googiehost.com/banner/468_68_2.gif" style="height:90px;width:468px;" border="0" alt="Free Hosting" /></a>
        </div>
		...
		<div class="card">
			...
			<div class="card-body">
				<form action="login/index.php" method="post" autocomplete="off">
					...
					<div class="input-group form-group">
						...
						<input type="password" name="contra" id="contra" required pattern="[A-Za-z0-9]{5,30}" class="form-control" placeholder="Contrase&ntilde;a">
					</div>
			...
			<div class="card-footer">
				<div class="d-flex justify-content-center links">
					No tienes cuenta?<a href="acceso.php">Registrate</a>
				</div>
				<div class="d-flex justify-content-center">
					<a href="pass.php">Olvidaste tu contrase&ntilde;a?</a>
				</div>
			</div>
		</div>
	</div>
