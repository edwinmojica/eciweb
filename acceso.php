...
<html>
<head>
	<title>Registrarse | DB_Tech | ECI</title>
		...
		<div class="card">
			<div class="card-header">
				...
				<!--div class="d-flex justify-content-end social_icon">
					...
					<a href="https://wa.me/573157612316?text=Hola, deseo informacion a cerca de sus servicios. Cordialmente: *Mojica´s*"><span><i class="fab fa-whatsapp-square"></i></span></a>
					<a href="#Twitter"><span><i class="fab fa-twitter-square"></i></span></a>
				</div-->
			</div>
			<div class="card-body">
				<form action="almacenar.php" method="post" autocomplete="off">
					<div class="input-group form-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="far fa-user"></i></span>
						</div>
						<input type="text" name="usuario" id="usuario" required pattern="[A-Za-z0-9]{5,30}" class="form-control" placeholder="Usuario">
					</div>
					...
					<div class="input-group form-group">
						...
						<input type="text" name="nombre" id="nombre" required pattern="[A-Za-z0-9]{5,30}" class="form-control" placeholder="Nombre">
					</div>
					...
					<div class="input-group form-group">
						...
						<input type="text" name="celular" id="celular" required  class="form-control" placeholder="Whatsapp">
					</div>
					<div class="input-group form-group" hidden>
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fab fa-whatsapp-square"></i></span>
						</div>
						<input type="text" name="ruta" id="ruta" required value="descarga.png" class="form-control" placeholder="ruta">
					</div>
					<div class="input-group form-group" hidden>
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fab fa-whatsapp-square"></i></span>
						</div>
						<input type="text" name="creador" id="creador" required value="Registro Local" class="form-control" placeholder="creador">
					</div>
